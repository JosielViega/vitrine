...
$activeNav = 'order';
?>
<div class="screen order-screen" data-page="order">
    <header class="topbar">
    ...
    <div class="order-content">
        ...
        <button class="whatsapp-button" type="button" data-checkout><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M20 11.5a8 8 0 0 1-11.8 7L4 20l1.5-4A8 8 0 1 1 20 11.5Z"/><path d="M9 8.5c.5 2.5 2 4 4.5 5"/></svg>Finalizar pedido no WhatsApp</button>
        ...
        <div class="order-service"><?php require dirname(__DIR__) . '/components/service-info.php'; ?><p>Após finalizar, você será direcionado ao nosso WhatsApp com seu pedido.</p></div>
